          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-gray-800/50 border-gray-600 text-white focus:border-orange-500"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 bg-gray-800/50 border-gray-600 text-white focus:border-orange-500"
