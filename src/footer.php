    <footer class="bg-gray-800/50 border-t border-gray-800">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-base text-gray-300 hover:text-white">AI Automation</a></li>
                        <li><a href="#" class="text-base text-gray-300 hover:text-white">Device Repairs</a></li>
                    </ul>
                </div>
                <div class="space-y-4">
            ...
            <div class="mt-12 border-t border-gray-700 pt-8 flex items-center justify-between">
                <p class="text-base text-gray-400">&copy; <?php echo date("Y"); ?> PINCOREHUB. All rights reserved.</p>
                <div class="flex space-x-6">
                    ...
                    <a href="#" class="text-gray-400 hover:text-gray-300"><span class="sr-only">Instagram</span><svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.024.06 1.378.06 3.808s-.012 2.784-.06 3.808c-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.024.048-1.378.06-3.808.06s-2.784-.013-3.808-.06c-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.048-1.024-.06-1.378-.06-3.808s.012-2.784.06-3.808c.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 016.343 2.525c.636-.247 1.363-.416 2.427-.465C9.792 2.013 10.146 2 12.315 2zM12 7.044c-2.533 0-4.566 2.033-4.566 4.566s2.033 4.566 4.566 4.566 4.566-2.033 4.566-4.566S14.533 7.044 12 7.044zm0 7.422a2.856 2.856 0 100-5.712 2.856 2.856 0 000 5.712zm5.17-6.21a1.107 1.107 0 100-2.214 1.107 1.107 0 000 2.214z" clip-rule="evenodd" /></svg></a>
